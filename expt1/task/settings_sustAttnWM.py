...
class ExperimentalDesign(object):
    ...
    def __init__(self,gui_specs):
        ...
        self.rts_runningmedslowthresh = np.zeros((self.nblocks,self.ntrials_perblock))
        self.rts_runningmedfastthresh = np.zeros((self.nblocks,self.ntrials_perblock))
        ...
        self.rt_triggered_med = np.zeros((self.nblocks,self.ntrials_perblock))
        self.rt_triggered = np.zeros((self.nblocks,self.ntrials_perblock))
        self.n_rt_triggered_slow = int(self.nprobetrials/3) #20 of each type of trial
        self.n_rt_triggered_fast = int(self.nprobetrials/3)
        self.n_rt_triggered_med = int(self.nprobetrials/3)
        ...
        self.rts_runningmedslowthresh[:,0:self.n_trials_atstart] = np.nan
        self.rts_runningmedfastthresh[:,0:self.n_trials_atstart] = np.nan
        self.rt_triggered_slow[:,0:self.n_trials_atstart] = np.nan
        self.rt_triggered_fast[:,0:self.n_trials_atstart] = np.nan
        self.rt_triggered_med[:,0:self.n_trials_atstart] = np.nan
